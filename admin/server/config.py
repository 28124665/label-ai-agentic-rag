...
class ServiceType(Enum):
    ...
    DATA_KNOWLEDGE_API_SERVER = "data-knowledge-api-server"
...
class DataKnowledgeAPIServerConfig(BaseConfig):
...
def load_configurations(config_path: str) -> list[BaseConfig]:
    ...
    configurations = []
    data_knowledge_api_count = 0
    id_count = 0
    for k, v in raw_configs.items():
        match k:
            case "data-knowledge-api":
                name: str = f'data-knowledge-api_{data_knowledge_api_count}'
                data_knowledge_api_count += 1
                host: str = v['host']
                http_port: int = v['http_port']
                config = DataKnowledgeAPIServerConfig(id=id_count, name=name, host=host, port=http_port,
                                             service_type="data-knowledge-api-server",
                                             detail_func_name="check_data_knowledge_api_server_alive")
