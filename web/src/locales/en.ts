...
Example: Virtual Hosted Style`,
      ...
      mineru: {
        ...
        accessTokenPlaceholder:
          'e.g. PAI-EAS token in Authorization header form (paste full value)',
...
[Insert text here]`,
      ...
      subQueryDecomposer: 'Sub Query Decomposer',
      hyde: 'HyDE',
      retryController: 'Retry Controller',
      graderDesc: 'Evaluate retrieval result relevance',
      hallucinationDetectorDesc: 'Detect hallucination in generated answers',
      queryRewriterDesc: 'Rewrite query based on complexity',
      subQueryDecomposerDesc: 'Decompose complex query into sub-queries',
      hydeDesc: 'Generate hypothetical document for retrieval',
      retryControllerDesc: 'Control retry logic based on result quality',
      evalMode: 'Evaluation Mode',
      batchSize: 'Batch Size',
      relevanceThreshold: 'Relevance Threshold',
      maxEvalTokens: 'Max Evaluation Tokens',
      passThreshold: 'Pass Threshold',
      filterThreshold: 'Filter Threshold',
      regenerateThreshold: 'Regenerate Threshold',
      ruleWeight: 'Rule Weight',
      nliWeight: 'NLI Weight',
      llmWeight: 'LLM Weight',
      strategy: 'Strategy',
      useLlmForSynonyms: 'Use LLM for Synonyms',
      minCount: 'Min Count',
      maxCount: 'Max Count',
      topK: 'Top K',
      dedupThreshold: 'Deduplication Threshold',
      rrfK: 'RRF K',
      ...
      maxRetryTokens: 'Max Retry Tokens',
      minRelevantDocs: 'Min Relevant Docs',
    },
    llmTools: {
      bad_calculator: {
        name: 'Calculator',
    ...
    admin: {
      ...
      grader: 'Grader',
      graderDescription: 'Evaluate retrieval results to filter out irrelevant documents and improve answer quality.',
      graderEvalMode: 'Evaluation Mode',
      ...
      graderBatchSize: 'Batch Size',
      graderBatchSizeTip: 'Number of documents to evaluate in each batch.',
      graderRelevanceThreshold: 'Relevance Threshold',
      graderRelevanceThresholdTip: 'Minimum relevance score (0-1) for a document to be considered relevant.',
      graderMaxEvalTokens: 'Max Eval Tokens',
      graderMaxEvalTokensTip: 'Maximum tokens allowed per evaluation request.',
      graderTimeout: 'Timeout',
      graderTimeoutTip: 'Evaluation timeout in seconds.',
      hallucinationDetector: 'Hallucination Detector',
      hallucinationDetectorDescription: 'Verify answer faithfulness against retrieved documents to detect and handle hallucinations.',
      hallucinationDetectorPassThreshold: 'Pass Threshold',
      hallucinationDetectorPassThresholdTip: 'Faithfulness score threshold to pass verification (0-1).',
      hallucinationDetectorFilterThreshold: 'Filter Threshold',
      hallucinationDetectorFilterThresholdTip: 'Faithfulness score threshold to trigger filtering (0-1).',
      hallucinationDetectorRegenerateThreshold: 'Regenerate Threshold',
      hallucinationDetectorRegenerateThresholdTip: 'Faithfulness score threshold to trigger regeneration (0-1).',
      hallucinationDetectorRuleWeight: 'Rule Weight',
      hallucinationDetectorRuleWeightTip: 'Weight for rule-based verification layer (0-1).',
      hallucinationDetectorNliWeight: 'NLI Weight',
      hallucinationDetectorNliWeightTip: 'Weight for NLI-based verification layer (0-1).',
      hallucinationDetectorLlmWeight: 'LLM Weight',
      hallucinationDetectorLlmWeightTip: 'Weight for LLM-based verification layer (0-1).',
      hallucinationDetectorTimeout: 'Timeout',
      hallucinationDetectorTimeoutTip: 'Detection timeout in seconds.',
      queryRewriter: 'Query Rewriter',
      queryRewriterDescription: 'Analyze query complexity and apply rewriting strategies to improve retrieval recall and precision.',
      queryRewriterStrategy: 'Strategy',
      queryRewriterStrategyTip: 'Select the rewriting strategy: synonym expansion, sub-query decomposition, or HyDE.',
      queryRewriterUseLlmForSynonyms: 'Use LLM for Synonyms',
      queryRewriterUseLlmForSynonymsTip: 'Use LLM to naturally integrate synonyms into the query.',
      subQueryDecomposer: 'Sub Query Decomposer',
      subQueryDecomposerDescription: 'Decompose complex queries into multiple sub-queries and merge results using RRF algorithm.',
      subQueryDecomposerMinCount: 'Min Count',
      subQueryDecomposerMinCountTip: 'Minimum number of sub-queries to generate.',
      subQueryDecomposerMaxCount: 'Max Count',
      subQueryDecomposerMaxCountTip: 'Maximum number of sub-queries to generate.',
      subQueryDecomposerTopK: 'Top K',
      subQueryDecomposerTopKTip: 'Number of results to retrieve per sub-query.',
      subQueryDecomposerDedupThreshold: 'Dedup Threshold',
      subQueryDecomposerDedupThresholdTip: 'Semantic similarity threshold for deduplication (0-1).',
      subQueryDecomposerRrfK: 'RRF K',
      subQueryDecomposerRrfKTip: 'Constant k in Reciprocal Rank Fusion algorithm.',
      hyde: 'HyDE',
      hydeDescription: 'Generate hypothetical document embeddings to improve retrieval for factual queries.',
      hydeEnableHyde: 'Enable HyDE',
      hydeEnableHydeTip: 'Enable hypothetical document embedding generation.',
      hydePrompt: 'HyDE Prompt',
      hydePromptTip: 'Prompt template for generating hypothetical documents.',
      hydeTemperature: 'Temperature',
      hydeTemperatureTip: 'Sampling temperature for generation (0-2).',
      hydeMaxTokens: 'Max Tokens',
      hydeMaxTokensTip: 'Maximum tokens for generated document.',
      retryController: 'Retry Controller',
      retryControllerDescription: 'Control retry logic based on retrieval quality, retry count, and token cost.',
      retryControllerMaxRetries: 'Max Retries',
      retryControllerMaxRetriesTip: 'Maximum number of retry attempts.',
      retryControllerMaxRetryTokens: 'Max Retry Tokens',
      retryControllerMaxRetryTokensTip: 'Maximum accumulated tokens allowed for retries.',
      retryControllerMinRelevantDocs: 'Min Relevant Docs',
      retryControllerMinRelevantDocsTip: 'Minimum number of relevant documents required to stop retrying.',
      retryControllerHasRelevant: 'Has Relevant',
      retryControllerHasRelevantTip: 'Variable reference for has_relevant state.',
      retryControllerRelevantCount: 'Relevant Count',
      retryControllerRelevantCountTip: 'Variable reference for relevant document count.',
      retryControllerRetryCount: 'Retry Count',
      retryControllerRetryCountTip: 'Variable reference for current retry count.',
      retryControllerAccumulatedRetryTokens: 'Accumulated Retry Tokens',
      retryControllerAccumulatedRetryTokensTip: 'Variable reference for accumulated retry tokens.',
    },
    explore: {
      title: 'Launch',
