...
DOC_ENGINE = os.environ.get("DOC_ENGINE", "postgresql").strip()  # 默认改为 postgresql
DOC_ENGINE_INFINITY = (DOC_ENGINE.lower() == "infinity")
DOC_ENGINE_OCEANBASE = (DOC_ENGINE.lower() == "oceanbase")
DOC_ENGINE_POSTGRESQL = (DOC_ENGINE.lower() == "postgresql")
DOC_ENGINE_ELASTICSEARCH = (DOC_ENGINE.lower() == "elasticsearch")
...
STORAGE_IMPL_TYPE = os.getenv('STORAGE_IMPL', 'OSS')
...
def init_settings():
    ...
    global DOC_ENGINE, DOC_ENGINE_INFINITY, DOC_ENGINE_OCEANBASE, DOC_ENGINE_ES, DOC_ENGINE_POSTGRESQL, docStoreConn, ES, OB, OS, INFINITY, POSTGRESQL
    DOC_ENGINE = os.environ.get("DOC_ENGINE", "postgresql").strip()  # 默认改为 postgresql
    DOC_ENGINE_INFINITY = (DOC_ENGINE.lower() == "infinity")
    DOC_ENGINE_OCEANBASE = (DOC_ENGINE.lower() == "oceanbase")
    DOC_ENGINE_POSTGRESQL = (DOC_ENGINE.lower() == "postgresql")
    DOC_ENGINE_ES = (DOC_ENGINE.lower() == "elasticsearch")
    ...
    if lower_case_doc_engine == "elasticsearch":
        ...
        POSTGRESQL = get_base_config("postgresql", {
        "host": "pgm-0jl31wqbx40n3mgx.pg.rds.aliyuncs.com",
        "port": 5432,
        "name": "boss_ai_data",
        "user": "boss_ai_data_rw",
        "password": "***REDACTED***"
        })
        docStoreConn = rag.utils.pg_conn.PGConnection()
    else:
    ...
    if DOC_ENGINE == "elasticsearch":
        ...
        import memory.utils.pg_conn as memory_pg_conn
        msgStoreConn = memory_pg_conn.MPGConnection()
